...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_timer_timer__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ng2_simple_timer__ = __webpack_require__(368);
...
var TimerPage = /** @class */ (function () {
    function TimerPage(navCtrl, navParams, timerProvider, st) {
    ...
    TimerPage.prototype.onSubmit = function (form) {
        console.log(form);
        console.log(this.timerProvider.prepareTime);
        this.startTimer();
    };
    TimerPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-timer',template:/*ion-inline-start:"C:\Users\pavli\Desktop\ANGULAR PROJECTS\Project SportTimer\sportsTimer\src\pages\timer\timer.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Создать новый таймер</ion-title>\n  </ion-navbar>\n</ion-header>\n  <ion-content padding>\n  <ion-list col-12>\n    <form  (ngSubmit)="onSubmit(form)" #form="ngForm">\n\n      <ion-item>\n        <ion-label>Время на подготовку</ion-label>\n        <ion-datetime displayFormat="m:s" doneText="Выбрать" cancelText="Отмена" name="prepareTime" [(ngModel)]="this.timerProvider.prepareTime"></ion-datetime>\n      </ion-item>\n\n      <ion-item>\n        <ion-label>Время для одного подхода</ion-label>\n        <ion-datetime displayFormat="m:s" name="approachTime" [(ngModel)]="this.timerProvider.approachTime"></ion-datetime>\n      </ion-item>\n\n        <ion-item>\n          <ion-label>Время для отдыха</ion-label>\n          <ion-datetime displayFormat="m:s" name="relaxTime" [(ngModel)]="this.timerProvider.relaxTime"></ion-datetime>\n        </ion-item>\n\n      <div padding ion-row col-12 justify-content-center>\n       <button ion-button block col-5 type="submit">Запустить</button>\n      </div>\n\n    </form>\n  </ion-list>\n\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\pavli\Desktop\ANGULAR PROJECTS\Project SportTimer\sportsTimer\src\pages\timer\timer.html"*/,
            providers: [__WEBPACK_IMPORTED_MODULE_2__providers_timer_timer__["a" /* TimerProvider */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_timer_timer__["a" /* TimerProvider */], __WEBPACK_IMPORTED_MODULE_3_ng2_simple_timer__["SimpleTimer"]])
    ], TimerPage);
    return TimerPage;
}());
...
var TimerProvider = /** @class */ (function () {
    function TimerProvider() {
        this.prepareTime = '2018-06-10T16:00:10.839Z';
        this.approachTime = '2018-06-10T16:00:30.839Z';
        this.relaxTime = '2018-06-10T16:00:10.839Z';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_list_list__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_timer_timer__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_timer_timer__ = __webpack_require__(204);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__pages_timer_timer__["a" /* TimerPage */]
            ],
            imports: [
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__providers_timer_timer__["a" /* TimerProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pages_home_home__ = __webpack_require__(341);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pages_list_list__ = __webpack_require__(342);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_timer_timer__ = __webpack_require__(147);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(platform, statusBar, splashScreen) {
        ...
        this.pages = [
            { title: 'Домой', component: __WEBPACK_IMPORTED_MODULE_4__pages_home_home__["a" /* HomePage */] },
            { title: 'Создать таймер', component: __WEBPACK_IMPORTED_MODULE_6__pages_timer_timer__["a" /* TimerPage */] },
            { title: 'Ваши тренировок', component: __WEBPACK_IMPORTED_MODULE_5__pages_list_list__["a" /* ListPage */] },
            { title: 'Программы тренировок', component: __WEBPACK_IMPORTED_MODULE_5__pages_list_list__["a" /* ListPage */] }
        ];
    }
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\pavli\Desktop\ANGULAR PROJECTS\Project SportTimer\sportsTimer\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n'/*ion-inline-end:"C:\Users\pavli\Desktop\ANGULAR PROJECTS\Project SportTimer\sportsTimer\src\app\app.html"*/
        }),
